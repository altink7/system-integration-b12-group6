...
public class AccountBalanceController {
    ...
    @GetMapping
    public AccountBalanceResponse getAccountBalance(@RequestParam("id") int id, @RequestParam("timestamp") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) Instant timestamp) {
